...
* Decide on the contents of [Node Requirements](nodes.md) using an [Advice Decision](decisions.md).
* Approve new [Enpsiral Nodes](nodes.md) and decomission inactive / rogue Nodes.
