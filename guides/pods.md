...
This guide aims to highlight the best resources we have to offer pods so that you and your pod members can have increasingly generative experiences.

Below you will find a number of principles, formats, and rituals that can be used to create and hold a space and practice that is generative for you and your pods’ members. Even if you are new to this don’t hesitate to invite your pod into these principles and practices. Pods are co-created experiences.

# Elements of pods

We have noticed that successful pods organise around the following elements; if you are _calling_ a group together (making the initial invitation and coordinating the first meeting) and you have a strong ideas regarding any of these elements, it’s good to share this as early as possible, perhaps in the invitation you make when you shoulder-tap potential pod members for your first call or meeting.
...
Before we introduce a few other significant patterns we’ve seen in successful pods, here are a few tips for callers as you begin:

### Starting your pod

#### Invitation
If you are the caller make the invitation very clear so people know what is your intention.


#### Name your Elders
_What’s the lineage that you are following? Who are you emulating or modelling after?_
...
A more practical, project-oriented exercise helping small group build collective intelligence by giving mutual support to their projects; [see here](/guides/project_kitchen.html).
...
Share & Show is an invitation for folks to _first and foremost_ share something they’ve produced or they’re proud of, and (if not that) then _secondarily_ anything that’s inspired them, that fascinates them, or may support insights for (members of) the group or good dialogue.
